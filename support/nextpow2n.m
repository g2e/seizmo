...
%    Usage:    p=nextpow2n(n)
%
%    Description: P=NEXTPOW2N(N) returns the next higher power of 2 for all
%     elements in N such that 2.^P>=abs(N).  This differs from NEXTPOW2
%     in that vectors and arrays are operated on element-wise. 
%
%    Notes:
%     - No checks.
%
...
%     Last Updated June 25, 2009 at 08:25 GMT
