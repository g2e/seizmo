function [y,li]=unsort(x,i,dim)
%UNSORT    Undoes a sort operation using the returned permutation indices
%
%    Description:  Undoes a previous sort operation using the permutation
%     matrix from that previous sort.  Useful for sorting
