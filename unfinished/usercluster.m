function [grp,ax]=usercluster(data,cg,cutoff,method,crit,pcut,varargin)
...
%              grp=usercluster(data,cg,cutoff,method,criterion,popcut)
%              grp=usercluster(data,cg,cutoff,method,criterion,popcut,...
...
%        Sep. 18, 2010 - added POPCUT & SELECTRECORDS into the fold
%
%     Written by Garrett Euler (ggeuler at wustl dot edu)
%     Last Updated Sep. 18, 2010 at 10:00 GMT
