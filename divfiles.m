...
%        June 29, 2008 - fixed amph2rlim handling, documentation update,
...
if(mod(nargopt,2))
    error('SAClab:divf:badNumOptions','Unpaired option(s)!')
end
...
if(any(nrecs~=1 & nrecs~=maxrecs))
    error('SAClab:divf:nrecsMismatch',...
