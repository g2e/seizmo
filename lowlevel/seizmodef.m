...
if(strcmpi(filetype,'SEIZMO Binary') || strcmpi(filetype,'SAC Binary'))
    ...
    def.enum.id={'ireal' 'itime' 'irlim' 'iamph' 'ixy' 'iunkn' 'idisp' ...
        ...
        'iex0' 'iqc' 'iqb0' 'igey' 'ilit' 'imet' 'iodor' 'iabsmnt' ...
        'iabsity' 'iabseler' 'iabserk' 'iabsnap' 'iabsackl' 'iabspop' ...
        'ijerk' 'isnap' 'icrackle' 'ipop' 'icounts' 'igcmt' 'igcmtq' ...
        'ireflect' 'ispecfem' 'imode' 'iwkbj'};
    ...
    def.enum.val=struct('ireal',0,'itime',1,'irlim',2,'iamph',3,'ixy',4,...
        ...
        'iodor',97,'iabsmnt',98,'iabsity',99,'iabseler',100,...
        'iabserk',101,'iabsnap',102,'iabsackl',103,'iabspop',104,...
        'ijerk',105,'isnap',106,'icrackle',107,'ipop',108,'icounts',109,...
        'igcmt',110,'igcmtq',111,'ireflect',112,'ispecfem',113,...
        'imode',114,'iwkbj',115);
