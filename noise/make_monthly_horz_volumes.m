...
%
%    Description:
%     MAKE_MONTHLY_HORZ_VOLUMES(STACK_DIR) creates fk-based slowness
%     response volumes for an array on a month to month basis independent
%     of year (eg stacked across years).  This only works on a directory
%     layout setup by DAYDIRS_STACKCORR.  The period range is 4 to 100s,
%     the maximum slowness is 50sec/deg and the slowness resolution is 1/3
%     sec/deg.
%
