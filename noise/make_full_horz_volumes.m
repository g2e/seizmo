...
%MAKE_FULL_HORZ_VOLUMES    Computes full-time fk volumes for horizontals
%
%    Usage:    make_full_horz_volumes(stack_dir)
%
%    Description:
%     MAKE_FULL_HORZ_VOLUMES(STACK_DIR) creates a fk-based slowness
%     response volume for an array.  This only works on a directory layout
...
%     sec/deg.  This will process only the full stack.
%
%    Notes:
%
%    Examples:
