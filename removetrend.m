...
%RTREND    Remove linear trend from SEIZMO data records
%
%    Description: RTREND(DATA) removes the linear trend from SEIZMO data 
...
%     Version History:
%        ????????????? - Initial Version
%        June 12, 2008 - Cleaned up doc and added example
%        Oct.  3, 2008 - .dep & .ind
%
