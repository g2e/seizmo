...
%     few more fields: .USERCLUSTER, .CLUSTER, .OUTLIERS.  Also plots and
%     info are saved during the analysis by the user.
%
%    Notes:
%
%    Examples:
...
%     Last Updated Jan.  6, 2011 at 13:35 GMT
...
for i=1:numel(results)
    ...
    [results(i).useralign.data,results(i).usercluster,...
        ...
        results(i).useralign.solution.pol]=adjustclusters(...
        results(i).useralign.data,results(i).usercluster,...
        results(i).useralign.solution.arr,...
