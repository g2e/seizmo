...
%
%    Description: IDX=GETSITEIDX(DATA) returns an array of indices that
%     indicate records in SEIZMO structure DATA belonging to a specific
%     site (aka location).  A site is defined by the fields KNETWK, KSTNM,
%     and KHOLE.  Usually this will separate records into groups based on
%     a specific sensor or sample rate.  The conventions employed vary from
%     network to network unfortunately so this isn't perfect by any means.
%
