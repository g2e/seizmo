...
%
%    Description: [VALUES,TIME,LAT,LON]=WW3MAT(WW3) converts WaveWatch
%     III data in the struct WW3 created through READ_GRIB to a matrix of
%     values and supporting vectors that indicate the time in TIME as well
%     as the latitudes and longitudes of the matrix in LAT/LON.  TIME is in
%     the format [YR MONTH DAY HOUR MINUTE SECOND] and LAT/LON are vectors
%     in units of degrees.  The grid is output as size NLATxNLON.
%
%    Notes:
%
%    Examples:
...
%      figure; imagesc(lon,lat,map); set(gca,'ydir','normal');
%
