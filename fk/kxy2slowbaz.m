...
%
%    Description: [S,BAZ]=KXY2SLOWBAZ(KX,KY,F) converts wavenumbers in the
%     East/West direction (Kx) and North/South direction (Ky) to slowness
%     S and backazimuth BAZ for frequency F.  Positive Kx correspond to
%     waves from the East heading West and positive Ky to waves from the
%     North going South.  The units of S depend on the units of Kx, Ky & F.
%     The distance units of Kx & Ky will match that of S, so if Kx & Ky are
