...
%     correspond to the same pair and the same lags.
%
...
%       and number of points.  That means NN(3), NE(3), EN(3), & EE(3) must
%       match on the corresponding header fields.
%     - Does not handle converting some sets to N/E and others to R/T.
%
%    Header changes:
...
%     Last Updated Nov.  7, 2012 at 13:30 GMT
