...
%
%    Description:
%     PZ=READSACPZ_RDSEED(FILE) reads in a SAC polezero file generated by
%     the program RDSEED (version 5.2+) and outputs a scalar structure PZ
%     containing all the information therein.  In particular this also
%     parses the information in the comment block above the pole, zero, &
%     constant info unlike READSACPZ which just discards this information.
...
%              PARSE_SACPZ_FILENAME, GETSACPZ, ISSACPZ_RDSEED,
