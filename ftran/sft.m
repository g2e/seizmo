...
%              sft(data,...,'colormap',cmap,...)
%              sft(data,...,'freqrange',frange,...)
%              sft(data,...,'dbrange',dbrange,...)
%              sft(data,...,'fontcolor',fcolor,...)
%              sft(data,...,'axis',handle,...)
%              data=sft(...)
%
%    Description: SFT(DATA) plots records in SEIZMO struct DATA as a trace
...
%
%     SFT(DATA,...,'COLORMAP',CMAP,...) alters the colormap used in the
...
%
%     SFT(DATA,...,'FONTCOLOR',FCOLOR,...) chooses the font color for all
%     the plots drawn by SFT.  FCOLOR may be a RGB triplet or a short/long
...
%     Last Updated June 24, 2011 at 18:25 GMT
