...
%     
%     DIVIDERECORDS(DATA1,DATA2) will divide the records in DATA1 by DATA2.
%     If either DATA1 or DATA2 are a single record, the record will be
%     applied to every record of the other dataset.  DATA1 and DATA2 must
%     contain the same number of records otherwise.
%     
%     DIVIDERECORDS(DATA1,DATA2,...,DATAN) divides records in datasets 2-N
%     from those in dataset 1.  Every dataset must have the same number of
...
%     
%     DIVIDERECORDS(...,'newhdr',true) controls the inheritance of header
%     fields and will set the resultant records' header fields to those of
%     the last record to be divided.  So
...
%     
%     DIVIDERECORDS(...,'begin','error|warn|ignore') sets the reaction to
...
%     
%     DIVIDERECORDS(...,'ref','error|warn|ignore') sets the reaction to
...
%     
%     DIVIDERECORDS(...,'iftype','error|warn|ignore') sets the reaction to
