...
%
%    Description: SRTM30PLUS2MAT(FILELIST1,...,FILELISTN) converts
%     SRTM30plus files into a Matlab .mat file for simpler loading. Accepts
%     char arrays of filenames (one filename per row) and/or cell arrays of
%     filenames (one filename per cell).  Wildcards are valid.  Passing an
%     empty list of files or no argument at all will bring up a graphical
%     file selection menu.  The .mat file is saved as 'srtm30plus.mat' in
%     the current working directory.  SRTM grids are saved as variables
%     according to the string preceeding the first '.' in their name.  So
...
%     Last Updated Feb. 14, 2010 at 16:50 GMT
