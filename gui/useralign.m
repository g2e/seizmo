function [arr,err,pol,zmean,zstd,nc,info]=useralign(data,varargin)
%USERALIGN    Interactive alignment of a signal for SEIZMO records
%
%    Usage:    [arr,err,pol,zmean,zstd,nc,info]=useralign(data)
%              [...]=useralign(data,'option1',value1,...,'optionN',valueN)
%
%    Description: [ARR,ERR,POL,ZMEAN,ZSTD,NC,INFO]=USERALIGN(DATA) presents
%     an interactive set of menus & plots to guide the user to align
...
%     for INFO.  INFO is a struct containing substructs providing details
%     for the options used in each subfunction (USERMOVEOUT, USERWINDOW,
%     USERTAPER, USERRAISE, CORRELATE, TTSOLVE).
%
...
%     perturbations to the expected arrival times:
