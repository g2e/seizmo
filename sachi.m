...
if(any(version==[6 101 200 201]))
    ...
    % SAClab version 200 header mod
    if(any(version==[200 201]))
        header.version=200;
        
        % change matlab header storage type
        header.store='double';
        
        % split v6 'single' group to 2 'double' groups 
        ...
        % push 'char' group to end (following SAC layout)
