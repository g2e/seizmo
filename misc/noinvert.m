...
%    Usage:    noinvert(fh)
%
%    Description: NOINVERT(FH) turns off hardcopy black & white inversion
%     performed by Matlab.  This is useful for figures with a black
%     background (something I do often here).  Obviously this is for
%     presentations -- not for actual printing!
%
%    Notes:
