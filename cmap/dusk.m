...
%    Usage:    map=dusk(m)
%
%    Description: MAP=DUSK(M) returns a Mx3 matrix of RGB color values
%     going through black, blue, violet, pink, tan & white.  This colormap
%     mimics the array of colors in the fading light after sunset and has a
%     strong pastel scheme.  DUSK by itself sets M to match the current
