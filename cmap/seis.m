...
%    Usage:    map=seis(m)
%
%    Description: MAP=SEIS(M) returns a Mx3 matrix of RGB color values
%     going from red to orange to yellow to green to blue.  SEIS by itself
...
%
%    See also: RED2GREEN, BLUE2RED, GREEN2BLUE, SPLIT, OCEAN, DRYWET,
