...
%
%    Description: MAP=NIGHTTIME(M) returns a Mx3 matrix of RGB color values
%     (even the map is created in HSV space) going from a dark to light
%     blue, then sharply to tan grading to a light pink.  This colormap
%     is useful when plotting NASA nighttime datasets.  NIGHTTIME by itself
...
%      colormap(nighttime)
%
%    See also: BLUE2RED, GREEN2BLUE, SPLIT, SEIS, OCEAN, DRYWET, FIRE,
