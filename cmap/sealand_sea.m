...
%
%    Description: MAP=SEALAND_SEA(M) returns a Mx3 matrix of RGB color
%     values going from violet to cyan to green to yellow.  SEALAND_SEA by
...
%              SEALAND_LAND, TOPO_LAND, RITZ, FIRE, NIGHTTIME,
