...
[dist1,az1,baz1]=vincentyinv(lat1,lon1,lat2,lon2);
[dist2,az2,baz2]=vincentyinv(lat2,lon2,lat1,lon1);
...
[lat3,lon3,baz3]=vincentyfwd(lat1,lon1,dist1,az1);
[lat4,lon4,baz4]=vincentyfwd(lat2,lon2,dist1,baz1);
[lat5,lon5,baz5]=vincentyfwd(lat1,lon1,dist2,baz2);
[lat6,lon6,baz6]=vincentyfwd(lat2,lon2,dist2,az2);
