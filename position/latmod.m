...
%     derivative).  The function is mainly useful for unwrapping latitude
...
%     Examples section below for how this is done.
%
%    Notes:
%     By convention:
...
%     shift necessary to preserve the actual position.  This may be done by
%     utilizing the second output to shift the longitude by 180 degrees if
%     there are an odd number of pole-crossings:
%      [LAT,P]=latmod(LAT,90);
